...
| **Layer Normalization** | A kernel for layer normalization, which normalizes activations within a layer to improve training stability in deep learning models.     | [1](https://isamu-website.medium.com/understanding-triton-tutorials-part-2-f6839ce50ae7) [2](https://triton-lang.org/main/getting-started/tutorials/05-layer-norm.html#sphx-glr-getting-started-tutorials-05-layer-norm-py) |
